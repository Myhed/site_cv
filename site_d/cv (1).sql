...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 14 Février 2017 à 07:25
...
INSERT INTO `competence` (`id_competence`, `competence`, `niveau`) VALUES
(1, 'HTML', 100),
(2, 'CSS', 75),
(3, 'PHP', 55),
(4, 'JAVASCRIPT', 40),
...
CREATE TABLE `experience` (
  ...
  `date_exp` longtext NOT NULL,
  `acquisition` longtext
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `experience` (`id_experience`, `experience`, `date_exp`, `acquisition`) VALUES
(1, ' Assistant administrateur rÃ©seaux', 'Novembre â€“ DÃ©cembre 2014', '-installation d\'un parc informatique,\n-sens de l\'ecoute,\n-travail en equipe,\n-relation client'),
(2, 'Technicien de maintenance informatique', 'Mars â€“ Avril 2014', '-Maintenance en informatiques,-relation client'),
(3, 'Technicien de maintenance informatique', 'Mai â€“ juin 2013', '-Maintenance informatiques,\n-relation client');
...
CREATE TABLE `formation` (
  ...
  `formation` longtext NOT NULL,
  `date_forma` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `formation` (`id_formation`, `formation`, `date_forma`) VALUES
(1, 'Baccalauréat S.E.N (Système électronique et numérique télécom-réseau) ', 'Juin 2015 ');
